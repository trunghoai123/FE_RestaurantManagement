        ...
        <div className="post-3">
            <div className="content-type">
                <ul>
                    ...
                    }} className={pathName == "/posts/list" && idActive === "1" ? "active" : ""}>Bài viết nổi bật</li>
                    <li onClick={()=>{
                        setIdActive("0")
                        navigate('/posts/list?id=0');
                        setActive(SCREEN.LIST)
                    }} className={pathName == "/posts/list" && idActive === "0" ? "active" : ""}>Tất cả bài viết</li>
                </ul>
                ...
                <ul>
                    {typePost?.map((item, idx)=>{
                        return <li onClick={()=>{
                            ...
                            setActive(SCREEN.LIST)
                        }} className={pathName == "/posts/list" && idActive === item._id ? "active" : ""}  key={idx}>{item.TenLoai}</li>
                    })}
                </ul>
            </div>
        </div>

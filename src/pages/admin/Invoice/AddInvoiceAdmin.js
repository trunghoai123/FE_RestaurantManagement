          ...
          <div className="col">
            <div className="item">
              ...
              <div className="row-item">
                ...
                <button
                  className={`btn-order type ${loaiHoaDon == 0 ? "active" : "choose"}`}
                  onClick={() => {
                    setLoaiHoaDon(0);
                  }}
                >
                ...
                <button
                  className={`btn-order type ${loaiHoaDon == 1 ? "active" : "choose"}`}
                  onClick={() => {
                    setLoaiHoaDon(1);
                  }}
                >
                ...
                <button
                  className={`btn-order type ${loaiHoaDon == 2 ? "active" : "choose"}`}
                  onClick={() => {
                    setLoaiHoaDon(2);
                  }}
                >

...
function CustomDropDown({  selectedItem , setSelectedItem , setLoading , allMenu}) {
    ...
    return (
        <DropDown>
            <div onClick={() => setDropdown(!dropdown)} className={dropdown ? "filter-custom" : "filter-custom click"}>
                <div className="filter-option">
                    ...
                    <div className="icon-down">
                        <svg width="18" height="10" viewBox="0 0 18 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M1 0.999998L9 9L17 1" stroke="#444444" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    </div>
                </div>
